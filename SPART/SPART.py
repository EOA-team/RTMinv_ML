    ...
    def run(self, debug=False):
        ...
        if self._tracker["soil"]:
            with nvtx.annotate('BSM model run', color='red'):
                soilopt = BSM(self._soilpar, self.optipar) # soil wet spectra from 400-2400nm
        ...
        sensor_wavelengths = self.sensorinfo["center_wvl"].T[0]
        ...
        return len(self.soilopt.refl[:, 0]) #results_table
        """
